...
export default function PagerdvScreen({ navigation }) {
  return (
    <View style={{ flex: 1 }}>
      <Header />
      <ImageBackground source={require('../../assets/images/medecin.jpg')} style={styles.background}>
        <View style={styles.content}>
          <Text style={styles.title}>Consultez votre médecin</Text>
          <TouchableOpacity style={styles.button} onPress={() => navigation.navigate('MedecinScreen')}>
