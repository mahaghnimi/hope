...
export default function HomeScreen({ navigation }) {
  ...
  const handleDossierPress = () => {
    navigation.navigate('ModifdossierScreen');
  };
  ...
  const handleParamPress = () => {
    navigation.navigate('PatparamScreen'); // Navigate to the ParamScreen
  };

  const menuOptions = [
    { id: '1', name: 'Profil', icon: 'person', onPress: handleProfilePress },
    { id: '2', name: 'Dossier Médical', icon: 'medical', onPress: handleDossierPress },
    { id: '3', name: 'Paramètres', icon: 'settings', onPress: handleParamPress },
    { id: '4', name: 'Déconnexion', icon: 'log-out', onPress: handleLogout },
  ];
    ...
    <View style={styles.container}>
      ...
      {isMenuVisible && (
        <View style={[styles.menuContainer, {zIndex: 1}]}>
          <FlatList
            data={menuOptions}
            renderItem={({ item }) => (
              <TouchableOpacity style={styles.menuItem} onPress={() => item.onPress ? item.onPress() : console.log("No action defined")}>
      ...
      <View style={styles.content}>
        ...
        <View style={styles.cardContainer}>
          <Card onPress={() => navigation.navigate('PagerdvScreen')} text="Rendez-Vous en ligne" imageSource={require('../../assets/images/rdv.jpeg')} />
          <Card onPress={() => navigation.navigate('ConsulterScreen')} text="Consultez Médecin" imageSource={require('../../assets/images/consumed.jpg')} />
        </View>
        <View style={styles.cardContainer}>
          <Card onPress={() => navigation.navigate('ConsultationenligneScreen')} text="Consultation en Ligne" imageSource={require('../../assets/images/consenligne.jpeg')} />
          <Card onPress={() => navigation.navigate('SuivremedScreen')} text="Suivre Médicaments" imageSource={require('../../assets/images/suivimed.jpeg')} />
        </View>
        <View style={styles.cardContainer}>
